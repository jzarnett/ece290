...
\alert{Common Mistake}: the parties understand each other but both have mistaken about certain facts.
...
There is a subsequent finding, in the case
\textit{Belle River Community Arena Inc. v W.J.C. Kaufmann Co. et al}.

This case drew a subsequent distinction 

This case appears in some documents but it has been overturned by a subsequent supreme court decision.

That is the famous \textit{R. v. Ron Engineering \& Construction (Eastern) Ltd.} which we will examine at a later time.
